...
public:
	...
	ID3D11Device* GetDevice() const { return mDev; }
	ID3D11DeviceContext* GetDeviceContext() const { return mDevCon; }
	ID3D11DepthStencilView* GetDepthView() const { return mDepthStencilView; }
