...
#pragma warning(pop)
	...
	{
		auto result = Vector3(a.y * b.z - a.z * b.y, a.z * b.x - a.x * b.z, a.x * b.y - a.y * b.x);
		return result;
	}
	...
	friend bool IsCloseEnuf(const Vector3& a, const Vector3& b)
	{
		return Math::IsCloseEnuf(a.x, b.x) && Math::IsCloseEnuf(a.y, b.y) && Math::IsCloseEnuf(a.z, b.z);
	}
